...
include::{samples-dir}/spring-session-data-mongodb-traditional-boot/pom.xml[tag=spring-data-mongodb]
...
[source,java]
----
include::{samples-dir}/spring-session-data-mongodb-traditional-boot/src/main/java/org/springframework/session/mongodb/examples/config/HttpSessionConfig.java[tag=class]
----
